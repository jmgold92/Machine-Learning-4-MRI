function [metrics,CM] = trainLDA_PCA(predictors,response,numComp,folds,posClass)
...
% Auto-generated by MATLAB on 15-Nov-2016 09:18:53
...
numComponentsToKeep = min(size(numericPredictors,2),numComp);
...
numClasses = length((min(response):1:max(response))');
